...
public class DataAnalysisController {
    ...
    public Result<Map<String, Integer>> getPatientAgeDistribution(@RequestParam Long doctorId) {
    ...
    public Result<Map<String, Integer>> getPatientGenderRatio(@RequestParam Long doctorId) {
    ...
    public Result<Map<String, Integer>> getPatientRegionalDistribution(@RequestParam Long doctorId) {
    ...
    public Result<Map<String, Integer>> getDepartmentWorkloadStatistics(
            ...
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate startDate,
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate endDate) {
        log.info("接收到获取科室工作量统计请求, doctorId: {}, startDate: {}, endDate: {}", doctorId, startDate, endDate);
        try {
